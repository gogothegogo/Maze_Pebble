...
#define SHAKE_WINDOW 0 //0 no window, 1 date, 2 seconds and date
...
typedef enum {
  ...
  AppKeyColorNotificationText = 9  
} AppKey;

static int settings[10]={BACKGROUND_TYPE, SHAKE_WINDOW, BLUETOOTH_ALARM, BATTERY_ICON, DATE_FORMAT, CROATIAN_DATE, COLOR_TIME_BACKGROUND, COLOR_TIME_TEXT, COLOR_NOTIF_TEXT};
...
static void settings_read () {
  ...
  APP_LOG(APP_LOG_LEVEL_INFO, "ColorDateText:%d ", settings[AppKeyColorNotificationText]);
}